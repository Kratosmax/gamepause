...
- 2026-08-21：`1.2.3` 本地 Release 构建 0 个警告、核心测试 29/29、更新器自测、WPF 视觉验收和四种发行包校验通过；GitHub Actions `32443269467` 成功发布 `v1.2.3`，线上 4 个发行包、3 个签名更新清单和 `SHA256SUMS.txt` 共 8 个资产均已上传，latest 路由和公开清单均指向 `1.2.3`。
...
`1.2.3` 已完成本地验证、提交、推送和线上发布。功能包含启动时检测并隐藏未启用的系统休眠入口。
