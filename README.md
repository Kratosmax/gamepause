...
> **重要升级提示：** 0.9.1 至 1.1.3 的自动更新版本校验无法读取压缩包中的 DLL，因此会在替换前安全失败。请从 [GitHub Releases](https://github.com/Kratosmax/gamepause/releases) 手动安装一次 1.1.4；用户档案和设置不会因此删除。升级到 1.1.4 后，后续自动更新恢复正常。
